...
/*
   ...
   */
   ...
   wire			regDest;		// From Decoder of mips_decode.v
   // End of automatics
   ...
   // Don't forget to hookup the "halted" signal to trigger the register dump 
	...
	mux3_1 #(32) writeData(rd_data,alu__out, ld_mem_data,shiftVal,
					{isShift,memToReg});
   ...
   mux3_1 #(5) shiftBy(sa,rs_data[4:0],dcd_shamt,5'd16,{isLui,isImm});
