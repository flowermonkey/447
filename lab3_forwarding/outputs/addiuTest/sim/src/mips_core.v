...
module stall_unit(stall, 
    ...
    input      [4:0]  dest, ex_dest, mem_dest, wb_dest;
    input             ex_we, mem_we, wb_we;
    input             ex_valid, mem_valid, wb_valid;
    ...
    assign stall = (~valid[dcd_rs])&&((~(ex_valid&(dcd_rs==ex_dest)&ex_we)) 
                                   &&(~(mem_valid&(dcd_rs==mem_dest)&mem_we))
                                   &&(~(wb_valid&(dcd_rs==wb_dest)&wb_we)))
                   ||(~valid[dcd_rt]) &&((~(ex_valid&(dcd_rt==ex_dest)&ex_we)) 
                                   &&(~(mem_valid&(dcd_rt==mem_dest)&mem_we))
                                   &&(~(wb_valid&(dcd_rt==wb_dest)&wb_we)))
                   ||(ctrl_Sys&(~valid[2]&&((~(ex_valid&(ex_dest==5'd2)&ex_we)) 
                                   &&(~(mem_valid&(mem_dest==5'd2)&mem_we))
                                   &&(~(wb_valid&(wb_dest==5'd2)&wb_we)))));
  ...
  /*         
       $display("count[0] = %d",count[0]);$display("count[1] = %d",count[1]);
       $display("count[2] = %d",count[2]);$display("count[3] = %d",count[3]);
       $display("count[4] = %d",count[4]);$display("count[5] = %d",count[5]);
       $display("count[6] = %d",count[6]);$display("count[7] = %d",count[7]);
       $display("count[8] = %d",count[8]);$display("count[9] = %d",count[9]);
       $display("count[10] = %d",count[10]);$display("count[11] = %d",count[11]);
       $display("count[12] = %d",count[12]);$display("count[13] = %d",count[13]);
       $display("count[14] = %d",count[14]);$display("count[15] = %d",count[15]);
       $display("count[16] = %d",count[16]);$display("count[17] = %d",count[17]);
       $display("count[18] = %d",count[18]);$display("count[19] = %d",count[19]);
       $display("count[20] = %d",count[20]);$display("count[21] = %d",count[21]);
       $display("count[22] = %d",count[22]);$display("count[23] = %d",count[23]);
*/ 
    end
endmodule
